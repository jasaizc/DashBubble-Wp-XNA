...
namespace DashBubble
{
    ...
    class Niveles22 : View
    {
            ...
            : base(game)
        {
            ...
            Nivel1 = new Button("/Nivel2/81", pos, game.Content);
            Nivel2 = new Button("/Nivel2/82", pos1, game.Content);
            Nivel3 = new Button("/Nivel2/83", pos2, game.Content);
            Nivel4 = new Button("/Nivel2/84", pos3, game.Content);
            Nivel5 = new Button("/Nivel2/85", pos4, game.Content);
            Nivel6 = new Button("/Nivel2/86", pos5, game.Content);
            Nivel7 = new Button("/Nivel2/87", pos6, game.Content);
            Nivel8 = new Button("/Nivel2/88", pos7, game.Content);
            Nivel9 = new Button("/Nivel2/89", pos8, game.Content);
            Nivel10 = new Button("/Nivel2/90", pos9, game.Content);
            Nivel11 = new Button("/Nivel2/91", pos10, game.Content);
            Nivel12 = new Button("/Nivel2/92", pos11, game.Content);
            Nivel13 = new Button("/Nivel2/93", pos12, game.Content);
            Nivel14 = new Button("/Nivel2/94", pos13, game.Content);
            Nivel15 = new Button("/Nivel2/95", pos14, game.Content);
            Nivel18 = new Button("/Nivel2/96", pos18, game.Content);
        ...
        {
            Variables.nivelActual = 80;
            game.Comenzar();
        }
        public void Pantalla2()
        {
            Variables.nivelActual = 81;
            game.Comenzar();
        }
        public void Pantalla3()
        {
            Variables.nivelActual = 82;
            game.Comenzar();
        }
        public void Pantalla4()
        {
            Variables.nivelActual = 83;
            game.Comenzar();
        }
        public void Pantalla5()
        {
            Variables.nivelActual = 84;
            game.Comenzar();
        }
        public void Pantalla6()
        {
            Variables.nivelActual = 85;
            game.Comenzar();
        }
        public void Pantalla7()
        {
            Variables.nivelActual = 86;
            game.Comenzar();
        }
        public void Pantalla8()
        {
            Variables.nivelActual = 87;
            game.Comenzar();
        }
        public void Pantalla9()
        {
            Variables.nivelActual = 88;
            game.Comenzar();
        }
        public void Pantalla10()
        {
            Variables.nivelActual = 89;
            game.Comenzar();
        }
        public void Pantalla11()
        {
            Variables.nivelActual = 90;
            game.Comenzar();
        }
        public void Pantalla12()
        {
            Variables.nivelActual = 91;
            game.Comenzar();
        }
        public void Pantalla13()
        {
            Variables.nivelActual = 92;
            game.Comenzar();
        }
        public void Pantalla14()
        {
            Variables.nivelActual = 93;
            game.Comenzar();
        }
        public void Pantalla15()
        {
            Variables.nivelActual = 94;
            game.Comenzar();
        }
        public void Pantalla16()
        {
            Variables.nivelActual = 95;
            game.Comenzar();
        }
        ...
        public override void Update()
        {
          ...
          //  Menu.Update(touchLocation);
            if (Variables.NivelCorrecto[80] == 1)
            {
                Nivel1.Update(touchLocation);
            }            
            if (Variables.NivelCorrecto[81] == 1)
            {
                Nivel2.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[82] == 1)
            {
                Nivel3.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[83] == 1)
            {
                Nivel4.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[84] == 1)
            {
                Nivel5.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[85] == 1)
            {
                Nivel6.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[86] == 1)
            {
                Nivel7.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[87] == 1)
            {
                Nivel8.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[88] == 1)
            {
                Nivel9.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[89] == 1)
            {
                Nivel10.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[90] == 1)
            {
                Nivel11.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[91] == 1)
            {
                Nivel12.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[92] == 1)
            {
                Nivel13.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[93] == 1)
            {
                Nivel14.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[94] == 1)
            {
                Nivel15.Update(touchLocation);
            }
            if (Variables.NivelCorrecto[95] == 1)
            {
        ...
        //    Menu.Draw(spriteBatch);
            ...
            spriteBatch.DrawString(fuente1, "81", pos0, Color.Black);
            spriteBatch.DrawString(fuente1, "82", pos1, Color.Black);
            spriteBatch.DrawString(fuente1, "83", pos2, Color.Black);
            spriteBatch.DrawString(fuente1, "84", pos3, Color.Black);
            spriteBatch.DrawString(fuente1, "85", pos4, Color.Black);
            spriteBatch.DrawString(fuente1, "86", pos5, Color.Black);
            spriteBatch.DrawString(fuente1, "87", pos6, Color.Black);
            spriteBatch.DrawString(fuente1, "88", pos7, Color.Black);
            spriteBatch.DrawString(fuente1, "89", pos8, Color.Black);
            spriteBatch.DrawString(fuente1, "90", pos9, Color.Black);
            spriteBatch.DrawString(fuente1, "91", pos10, Color.Black);
            spriteBatch.DrawString(fuente1, "92", pos11, Color.Black);
            spriteBatch.DrawString(fuente1, "93", pos12, Color.Black);
            spriteBatch.DrawString(fuente1, "94", pos13, Color.Black);
            spriteBatch.DrawString(fuente1, "95", pos14, Color.Black);
            spriteBatch.DrawString(fuente1, "96", pos18, Color.Black);
            spriteBatch.DrawString(fuente, "81", pos0, Color.White);
            spriteBatch.DrawString(fuente, "82", pos1, Color.White);
            spriteBatch.DrawString(fuente, "83", pos2, Color.White);
            spriteBatch.DrawString(fuente, "84", pos3, Color.White);
            spriteBatch.DrawString(fuente, "85", pos4, Color.White);
            spriteBatch.DrawString(fuente, "86", pos5, Color.White);
            spriteBatch.DrawString(fuente, "87", pos6, Color.White);
            spriteBatch.DrawString(fuente, "88", pos7, Color.White);
            spriteBatch.DrawString(fuente, "89", pos8, Color.White);
            spriteBatch.DrawString(fuente, "90", pos9, Color.White);
            spriteBatch.DrawString(fuente, "91", pos10, Color.White);
            spriteBatch.DrawString(fuente, "92", pos11, Color.White);
            spriteBatch.DrawString(fuente, "93", pos12, Color.White);
            spriteBatch.DrawString(fuente, "94", pos13, Color.White);
            spriteBatch.DrawString(fuente, "95", pos14, Color.White);
            spriteBatch.DrawString(fuente, "96", pos18, Color.White);
