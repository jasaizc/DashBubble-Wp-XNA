...
namespace DashBubble
{
    ...
    class MenuMusica : View
    {
        ...
        private Vector2 pos3 = new Vector2(40,320);
        private Vector2 pos4 = new Vector2(90, 350);
        ...
        {
            {
               ...
               // launcher = game.Content.Load<Texture2D>("arrow");
                  ...
                  fuente = game.Content.Load<SpriteFont>("Letras/Musica");
       ...
       //     PasarNivel.Update(touchLocation);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
           ...
           // spriteBatch.Draw(game.textTecho, new Vector2(limiteIzquierdo - 20, (limiteArriba + (game.posTecho * tamanoBurbuja)) - 705), null, Color.White);
            ...
            spriteBatch.DrawString(fuente, "You Music Stopped", pos3, Color.Black);
            spriteBatch.DrawString(fuente, "Now, You sure?", pos4, Color.Black);
